        ...
        <>
            ...
            <div className={classes.container}>
                ...
                <p>
                    ...
                    wyjątkowego i wygenerujesz kod QR. Taki kod lub link należy udostępnić osobie dla której
                    jest ta kartka. Po wejściu w link ta osoba zobaczy twoją kartkę z życzeniami.
                </p>
                <h2>Tworzenie kartki </h2>
                <p>
                    Przejdź do naszego generatora gdzie zobaczysz obszerny formularz z konfiguracją wyglądu
                    kartki. W każdej chwili możesz użyć przycisku do podglądu. Polecam to robić jak
                    najczęściej. Do dostosowania są trzy sekcje: Tło, Sekcja główna i Sekcja z życzeniami. Na
                    końcu formularza zobaczysz przycisk z wygenerowaniem kodu QR i linku który możesz przesłać
                    osobie którą chcesz obdarować.
                </p>
